...
public class FigureTest {
    @Test
    void isBelong() {
        Rectangle a= new Rectangle(100,200,10,10, Color.red, 5, null);
        Circle b = new Circle(100,200,100, Color.red, 5, null);
        Circle c = new Circle(400,400,200, Color.red, 5, null);
    ...
    void validatorValid() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Rectangle a = new Rectangle(10,10,10,10,Color.red, 5, null);
    ...
    void validatorInvalidX() {
        assertThrows(IllegalArgumentException.class, ()->{new Rectangle(-10,10,10,10,Color.red, 5, null);});
    }
    @Test
    ...
    void validatorInvalidWidth() {
        assertThrows(IllegalArgumentException.class, ()->{new Rectangle(10,10,100000,10,Color.red, 5, null);});
    }
    @Test
    void validatorInvalidHeight() {
        assertThrows(IllegalArgumentException.class, ()->{new Rectangle(10,10,10,100000,Color.red, 5, null);});
    }
    @Test
    void validatorNegativeWidth() {
        assertThrows(IllegalArgumentException.class, ()->{new Rectangle(10,10,-1,10,Color.red, 5, null);});
    }
    @Test
    void validatorNegativeHeight() {
        assertThrows(IllegalArgumentException.class, ()->{new Rectangle(10,10,10,0,Color.red, 5, null);});
    }
